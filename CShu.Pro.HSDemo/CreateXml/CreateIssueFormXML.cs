...
namespace CShu.Pro.HSDemo
{
    ...
    /// 材料出入库==生产领料、退料
    /// </summary>
    public class CreateIssueFormXML
    {
        public static string CreateRequestXml()
        {
            ...
            //材料入出库单头 单号
            //日期
            xmlBuilder.Append("<PrivateDescSeg4>2019-1-31</PrivateDescSeg4>");
            //确认日期
            xmlBuilder.Append("<PrivateDescSeg5>2019-1-31</PrivateDescSeg5>");
            //收发类型
            ...
            //创建时间				
            xmlBuilder.Append("<PrivateDescSeg9>2019-1-31</PrivateDescSeg9>");
            //修改人				
            xmlBuilder.Append("<PrivateDescSeg10>cshu</PrivateDescSeg10>");
            //修改时间				
            xmlBuilder.Append("<PrivateDescSeg11>2019-1-31</PrivateDescSeg11>");
            xmlBuilder.Append("</head>");
            ...
            //单行 生产订单				
            xmlBuilder.Append("<PrivateDescSeg4>10MO190105044</PrivateDescSeg4>");
            //单行 生产订单备料行号				
            xmlBuilder.Append("<PrivateDescSeg5>160</PrivateDescSeg5>");
            //单行 料号				
            xmlBuilder.Append("<PrivateDescSeg6>18010010148</PrivateDescSeg6>");
            //单行 应发时间				
            xmlBuilder.Append("<PrivateDescSeg7>2019-1-31</PrivateDescSeg7>");
            //单行 VMI标识				
            xmlBuilder.Append("<PrivateDescSeg8>true</PrivateDescSeg8>");
            //单行 应发数量（发料单位）			
            xmlBuilder.Append("<PrivateDescSeg9>6</PrivateDescSeg9>");
            //单行 材料出库数量（发料单位）			
            xmlBuilder.Append("<PrivateDescSeg10>4</PrivateDescSeg10>");
            //单行 供应地点编码				
            xmlBuilder.Append("<PrivateDescSeg11>10C01</PrivateDescSeg11>");
            //单行 项目编码				
            ...
            //单行 创建人				
            xmlBuilder.Append("<PrivateDescSeg14>cshu</PrivateDescSeg14>");
            //单行 创建时间				
            xmlBuilder.Append("<PrivateDescSeg15></PrivateDescSeg15>");
            //单行 修改人				
            xmlBuilder.Append("<PrivateDescSeg16>cshu</PrivateDescSeg16>");
            //单行 修改时间				
