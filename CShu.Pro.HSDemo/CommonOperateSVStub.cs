...
[System.ServiceModel.ServiceContractAttribute(Name="YY.U9.Cust.HS.Interface.ICommonOperateSV", Namespace="http://www.UFIDA.org", ConfigurationName="YYU9CustHSInterfaceICommonOperateSV")]
public interface YYU9CustHSInterfaceICommonOperateSV
{
    
    [System.ServiceModel.OperationContractAttribute(Action="http://www.UFIDA.org/YY.U9.Cust.HS.Interface.ICommonOperateSV/Do", ReplyAction="http://www.UFIDA.org/YY.U9.Cust.HS.Interface.ICommonOperateSV/DoResponse")]
    [System.ServiceModel.FaultContractAttribute(typeof(UFSoft.UBF.Service.ServiceLostException), Action="http://www.UFIDA.org/YY.U9.Cust.HS.Interface.ICommonOperateSV/DoServiceLostExcept" +
        "ionFault", Name="ServiceLostException", Namespace="http://schemas.datacontract.org/2004/07/UFSoft.UBF.Service")]
    [System.ServiceModel.FaultContractAttribute(typeof(UFSoft.UBF.Service.ServiceException), Action="http://www.UFIDA.org/YY.U9.Cust.HS.Interface.ICommonOperateSV/DoServiceExceptionF" +
        "ault", Name="ServiceException", Namespace="http://schemas.datacontract.org/2004/07/UFSoft.UBF.Service")]
    [System.ServiceModel.FaultContractAttribute(typeof(UFSoft.UBF.Service.ServiceExceptionDetail), Action="http://www.UFIDA.org/YY.U9.Cust.HS.Interface.ICommonOperateSV/DoServiceExceptionD" +
        "etailFault", Name="ServiceExceptionDetail", Namespace="http://schemas.datacontract.org/2004/07/UFSoft.UBF.Service")]
    [System.ServiceModel.FaultContractAttribute(typeof(UFSoft.UBF.ExceptionBase), Action="http://www.UFIDA.org/YY.U9.Cust.HS.Interface.ICommonOperateSV/DoExceptionBaseFaul" +
        "t", Name="ExceptionBase", Namespace="http://schemas.datacontract.org/2004/07/UFSoft.UBF")]
    [System.ServiceModel.FaultContractAttribute(typeof(System.Exception), Action="http://www.UFIDA.org/YY.U9.Cust.HS.Interface.ICommonOperateSV/DoExceptionFault", Name="Exception", Namespace="http://schemas.datacontract.org/2004/07/System")]
    ...
    [System.ServiceModel.ServiceKnownTypeAttribute(typeof(System.Exception[]))]
    string Do(out UFSoft.UBF.Exceptions1.MessageBase[] outMessages, object context, string[] requestInfos);
}

[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
public interface YYU9CustHSInterfaceICommonOperateSVChannel : YYU9CustHSInterfaceICommonOperateSV, System.ServiceModel.IClientChannel
{
}

[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
public partial class YYU9CustHSInterfaceICommonOperateSVClient : System.ServiceModel.ClientBase<YYU9CustHSInterfaceICommonOperateSV>, YYU9CustHSInterfaceICommonOperateSV
{
    
    public YYU9CustHSInterfaceICommonOperateSVClient()
    {
    }
    
    public YYU9CustHSInterfaceICommonOperateSVClient(string endpointConfigurationName) : 
            base(endpointConfigurationName)
    {
    }
    
    public YYU9CustHSInterfaceICommonOperateSVClient(string endpointConfigurationName, string remoteAddress) : 
            base(endpointConfigurationName, remoteAddress)
    {
    }
    
    public YYU9CustHSInterfaceICommonOperateSVClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
            base(endpointConfigurationName, remoteAddress)
    {
    }
    
    public YYU9CustHSInterfaceICommonOperateSVClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
            base(binding, remoteAddress)
    {
    }
    
    public string Do(out UFSoft.UBF.Exceptions1.MessageBase[] outMessages, object context, string[] requestInfos)
    {
        return base.Channel.Do(out outMessages, context, requestInfos);
    }
}
