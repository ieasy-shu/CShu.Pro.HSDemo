...
namespace CShu.Pro.HSDemo
{
    ...
    /// 杂收
    /// </summary>
    public class CreateMiscRcvTransXML
    {
        public static string CreateRequestXml()
        {
            string businessType = "MiscRcvTrans";
            ...
            //单号
            xmlBuilder.Append("<PrivateDescSeg3>10ZS190124001</PrivateDescSeg3>");
            //日期
            ...
            //库存数量
            xmlBuilder.Append("<PrivateDescSeg4>500</PrivateDescSeg4>");
            //存储地点编码
            xmlBuilder.Append("<PrivateDescSeg5>10A01</PrivateDescSeg5>");
            //项目编码
            ...
            ////库存数量
            //xmlBuilder.Append("<PrivateDescSeg4>350</PrivateDescSeg4>");
            ////存储地点编码
            ...
            ////存储地点编码
            //xmlBuilder.Append("<PrivateDescSeg5>10H01</PrivateDescSeg5>");
            ////项目编码
            //xmlBuilder.Append("<PrivateDescSeg6>10</PrivateDescSeg6>");
            ////修改人
            //xmlBuilder.Append("<PrivateDescSeg7>cshu</PrivateDescSeg7>");
